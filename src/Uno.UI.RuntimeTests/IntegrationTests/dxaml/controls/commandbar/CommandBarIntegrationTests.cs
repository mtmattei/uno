	...
	public class CommandBarIntegrationTests : BaseDxamlTestClass
	{
		...
		public async Task CanAddToAndRemoveFromCommandCollections()
		{
			...
			await RunOnUIThread(() =>
			{
				CommandBar cmdBar = (CommandBar)XamlReader.Load(@"
					<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" >
                        <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn1""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn2""/>
                        <CommandBar.SecondaryCommands>
                            <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn3""/>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn4""/>
		...
		public async Task ValidateOverflowSnapsToWindowWidth()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				WindowHelper.WindowContent = cmdBar;
			});
		...
		public async Task CanResizeCommandBarAfterOpeningAndClosing()
		{
			...
			await RunOnUIThread(() =>
			{
				cmdBar = (CommandBar)XamlReader.Load(@"
					<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" Margin=""0,0,100,0"">
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn1""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn2""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn3""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn4""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn5""/>
                        <CommandBar.SecondaryCommands>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn1""/>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn2""/>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""btn3""/>
		...
		public async Task CanUseLargeAppBarButton()
		{
			...
			await RunOnUIThread(() =>
			{
				cmdBar = (CommandBar)XamlReader.Load(@"
					<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" >
                      <CommandBar.SecondaryCommands>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""AppBarButton"" Height=""1000"">
                          <AppBarButton.Flyout>
                            <MenuFlyout>
		...
		public async Task CanMaintainFocusAfterCollectionOrSizeChange()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				WindowHelper.WindowContent = commandBar;
			});
			await WindowHelper.WaitForIdle();
		...
		private async Task DoesCycleFocusWhenOpenWorker(Location location, int numTabs, string expectedFocusSequence)
		{
			...
			await RunOnUIThread(() =>
			{
				...
				cmdBar = (CommandBar)XamlReader.Load(@"
					<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" >
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Tag=""P1""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Tag=""P2""/>
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Tag=""P3""/>
                        <CommandBar.SecondaryCommands>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Tag=""S1""/>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Tag=""S2""/>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Tag=""S3""/>
                        </muxc:CommandBar.SecondaryCommands>
                    </muxc:CommandBar>
				");
		...
		public async Task DoesFocusExpandButtonWithOverflowEscKey()
		{
			...
			Page rootPage = (Page)XamlReader.Load(@"<Page    
				...
				<Grid Background=""{ThemeResource ApplicationPageBackgroundThemeBrush}"">
					<StackPanel>
						<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""topCommandBar"">
							<CommandBar.SecondaryCommands>
								<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""AppBarButton"" VerticalAlignment=""Top"" x:Name=""topOverflowAppBarBtn0""/>
								<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""AppBarToggleButton"" VerticalAlignment=""Top"" x:Name=""topOverflowAppBarBtn1""/>
								<AppBarSeparator xmlns=""using:Microsoft.UI.Xaml.Controls""/>
							</muxc:CommandBar.SecondaryCommands>
							<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""AppBarButton"" Icon=""FourBars"" x:Name=""topAppBarBtn0""/>
							<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""AppBarToggleButton"" Icon=""HangUp"" x:Name=""topAppBarBtn1""/>
							<AppBarSeparator xmlns=""using:Microsoft.UI.Xaml.Controls""/>
						</muxc:CommandBar>
				...
				<Page.BottomAppBar>
					<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""bottomCommandBar"">
						<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Shuffle"" Label=""Shuffle"" x:Name=""bottomAppBarBtn0""/>
						<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""RepeatAl"" Label=""Repeat"" x:Name=""bottomAppBarBtn1""/>
						<AppBarSeparator xmlns=""using:Microsoft.UI.Xaml.Controls""/>
						<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Back"" Label=""Back"" x:Name=""bottomAppBarBtn2""/>
						<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Stop"" Label=""Stop"" x:Name=""bottomAppBarBtn3""/>
						<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Play"" Label=""Play"" x:Name=""bottomAppBarBtn4""/>

						<CommandBar.SecondaryCommands>
							<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Like"" Label=""Like"" x:Name=""bottomOverflowAppBarBtn0""/>
							<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Dislike"" Label=""Dislike"" x:Name=""bottomOverflowAppBarBtn1""/>
						</muxc:CommandBar.SecondaryCommands>
					</muxc:CommandBar>
				</Page.BottomAppBar>
			</Page>");
		...
		public async Task ValidateMenuSizingForDifferentInputModes()
		{
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                          xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" >
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBar"" VerticalAlignment=""Bottom"" HorizontalAlignment=""Center"" >
                            <CommandBar.SecondaryCommands>
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarButton"" Label=""Item 1"" />
                                <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarToggleButton"" Label=""Item 2"" />
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
				...
				expectedMenuWidth_Touch = (double)root.Resources.Lookup("CommandBarOverflowTouchMinWidth");
				expectedMenuWidth_NonTouch = (double)root.Resources.Lookup("CommandBarOverflowMinWidth");
			...
			await RunOnUIThread(() =>
			{
				...
				VERIFY_ARE_EQUAL(Math.Floor(appBarButton.ActualHeight), expectedMenuItemHeight_NonTouch);
				VERIFY_ARE_EQUAL(Math.Floor(appBarToggleButton.ActualHeight), expectedMenuItemHeight_NonTouch);
			});
			await CloseCommandBar(cmdBar);
		...
		public async Task ValidateVisualStateForFullWidthMenu()
		{
			...
			await RunOnUIThread(() =>
			{
				var root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                          xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" >
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBar"" VerticalAlignment=""Bottom"" >
                            <CommandBar.SecondaryCommands>
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""Item 1"" />
                                <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""Item 2"" />
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
				...
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                        ...
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBar"" VerticalAlignment=""Bottom"" HorizontalAlignment=""Center"" >
                            <CommandBar.PrimaryCommands>
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarButton1"" Label=""Item 1"" />
                                <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarToggleButton1"" Label=""Item 2"" />
                            </muxc:CommandBar.PrimaryCommands>
                            <CommandBar.SecondaryCommands>
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarButton2"" Label=""Item 4"" />
                                <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarToggleButton2"" Label=""Item 5"" />
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
		...
		public async Task ValidateFootprint()
		{
			...
			double expectedCommandBarWidth = 1024;
			...
			await RunOnUIThread(() =>
			{
				var rootPanel = (StackPanel)XamlReader.Load(@"<StackPanel xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBarCompactClosed"" IsOpen=""False"" ClosedDisplayMode=""Compact""/>
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBarCompactOpen"" IsOpen=""True"" ClosedDisplayMode=""Compact""/>
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBarMinimalClosed"" IsOpen=""False"" ClosedDisplayMode=""Minimal""/>
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBarMinimalOpen"" IsOpen=""True"" ClosedDisplayMode=""Minimal""/>
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBarHiddenClosed"" IsOpen=""False"" ClosedDisplayMode=""Hidden""/>
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBarHiddenOpen"" IsOpen=""True"" ClosedDisplayMode=""Hidden""/>
                    </StackPanel>");
		...
		public async Task ValidateDynamicOverflowWithCustomAppBarButton()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				cmdBar = (CommandBar)XamlReader.Load(@"<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
		...
		public async Task CanArrowIntoTheContentArea()
		{
			...
			{
				cmdBar = (CommandBar)XamlReader.Load(@"<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"">
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""button"" Icon=""Accept""/>
                        <CommandBar.Content>
		...
		public async Task DoesOpenOverflowWithArrowInputOnMoreButton()
		{
			...
			await RunOnUIThread(() =>
			{
				cmdBar = (CommandBar)XamlReader.Load(@"<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"">
                        <CommandBar.SecondaryCommands>
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""menu item 1"" />
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""menu item 2"" />
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""menu item 3"" />
                        </muxc:CommandBar.SecondaryCommands>
                    </muxc:CommandBar>");
		...
		public async Task ValidateForegroundForXamlUICommand()
		{
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                            ...
                            <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" DefaultLabelPosition=""Right"" Foreground=""Blue"">
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""Button1"" IsEnabled=""False"" Label=""Accept"" >
                                    <IconSourceElement>
                                            <SymbolIconSource Symbol=""Favorite"" Foreground=""Red"" />
                                    </IconSourceElement>
                                </AppBarButton>
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""ButtonWithCommand1"" IsEnabled=""False"" Command=""{StaticResource AcceptCommand}"" />
                                <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""ButtonWithCommand2"" IsEnabled=""False"" Command=""{StaticResource FavoriteCommand}"" />
                            </muxc:CommandBar>
                        </Grid>");
			...
			await RunOnUIThread(() =>
			{
				rootGrid = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
                        <Grid>
                            ...
                            <Grid>
                                <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" HorizontalAlignment=""Right"" x:Name=""CommandBar"">
                                    <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Add"" Label=""Add""/>
                                </muxc:CommandBar>
                            </Grid>
		...
		public async Task VerifyVisibilityChangeUpdatesCommandBarVisualState()
		{
			...
			await RunOnUIThread(() =>
			{
				var root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                          xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" >
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBar"" VerticalAlignment=""Top"" >
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""Item 1"" Name=""button"" Visibility=""Collapsed""/>
                            <CommandBar.SecondaryCommands>
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""Item 2""/>
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
		...
		public async Task ValidateResetingTheStateOfAppBarButton()
		{
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                              xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" >
                        <CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""cmdBar"">
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""Button"" Icon=""Add""/>
                            <AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""ToggleButton"" Icon=""AddFriend"" />
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" IsEnabled=""False"" Icon=""Cancel"" Label=""PlaceHolder"" />
                            <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""ApproveButton"" Icon=""Accept"" />
                        </muxc:CommandBar>
                    </Grid>");
						...
						<Button x:Name=""FlyoutButton"" Content=""Click for flyout"">
							<Button.Flyout>
								<Flyout x:Name=""CommandBarFlyout"">
									<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""CommandBar"" IsOpen=""True"" Width=""300"">
										<CommandBar.SecondaryCommands>
											<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""MenuFlyoutAppBarButton1"" Label=""Open menu flyout"">
												<AppBarButton.Flyout>
											...
											<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""MenuFlyoutAppBarButton2"" Label=""Open other menu flyout"">
												<AppBarButton.Flyout>
											...
											<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""MenuFlyoutAppBarButton3"" Label=""Open third menu flyout"">
												<AppBarButton.Flyout>
											...
											<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""AppBarButtonWithoutFlyout"" Label=""No menu flyout"" />
											<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""AppBarToggleButton"" Label=""No menu flyout"" />
										</muxc:CommandBar.SecondaryCommands>
									</muxc:CommandBar>
								</Flyout>
							</Button.Flyout>
			...
			await RunOnUIThread(() =>
			{
				...
				var root = (Grid)(XamlReader.Load(
					@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
							  xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
							  Background=""Transparent"">
							<CommandBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""CommandBar"" Width=""300"">
								<CommandBar.SecondaryCommands>
									<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""FlyoutAppBarButton"" Label=""Open flyout"">
										<AppBarButton.Flyout>
									...
									<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""OtherAppBarButton"" Label=""Other AppBarButton"" />
								</muxc:CommandBar.SecondaryCommands>
							</muxc:CommandBar>
						</Grid>"));
