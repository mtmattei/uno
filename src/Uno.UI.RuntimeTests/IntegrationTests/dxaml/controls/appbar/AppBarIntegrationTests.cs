...
namespace Windows.UI.Tests.Enterprise.AppBarTests
{
	...
	public class AppBarIntegrationTests : BaseDxamlTestClass
	{
		...
		public async Task CanCloseNonStickyAppBarUsingEscapeKey()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				stickyInlineAppBar = (AppBar)XamlReader.Load(@"
					<AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
			...
			await RunOnUIThread(() =>
			{
				var root = (FrameworkElement)XamlReader.Load(@"
					<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
						<AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBar"" ClosedDisplayMode=""Minimal"" Width=""320""/>
					</Grid>
				");
		...
		public async Task ValidateAppBarWithParentedLTE()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				appBar = (AppBar)XamlReader.Load(@"
					<AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" Width=""200"" Height=""80"">
                        <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Label=""AppBarButton""/>
                    </AppBar>
				");
		...
		public async Task CanClosedDisplayModesAffectTabbingWhenClosed()
		{
			...
			rootPage = (Page)XamlReader.Load(@"
				<Page
					...
					<Page.TopAppBar>
						<AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" ClosedDisplayMode=""Minimal"">
							<StackPanel Orientation=""Horizontal"">
								<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""FirstAppBarButton"" Icon=""ReShare"" Label=""Share"" Tag=""AB1""/>
								<AppBarSeparator xmlns=""using:Microsoft.UI.Xaml.Controls"" />
								<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Favorite"" Label=""Favorite"" Tag=""AB2""/>
								<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Edit"" Label=""Edit"" Tag=""AB3""/>
							</StackPanel>
						</AppBar>
					</Page.TopAppBar>

					<Page.BottomAppBar>
						<AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" ClosedDisplayMode=""Compact"">
							<StackPanel Orientation=""Horizontal"">
								<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""ReShare"" Label=""Share"" Tag=""AB4""/>
								<AppBarSeparator xmlns=""using:Microsoft.UI.Xaml.Controls"" />
								<AppBarToggleButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Favorite"" Label=""Favorite"" Tag=""AB5""/>
								<AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" Icon=""Edit"" Label=""Edit"" Tag=""AB6""/>
							</StackPanel>
						</AppBar>
					</Page.BottomAppBar>
		...
		public async Task ValidateFootprint()
		{
			...
			double expectedAppBarWidth = 500;
			...
			await RunOnUIThread(() =>
			{
				var rootPanel = (StackPanel)XamlReader.Load(@"
					<StackPanel xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
								...
								Width=""500""
								Height=""600"">
                        <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarCompactClosed"" IsOpen=""False"" ClosedDisplayMode=""Compact""/>
                        <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarCompactOpen"" IsOpen=""True"" ClosedDisplayMode=""Compact""/>
                        <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarMinimalClosed"" IsOpen=""False"" ClosedDisplayMode=""Minimal""/>
                        <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarMinimalOpen"" IsOpen=""True"" ClosedDisplayMode=""Minimal""/>
                        <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarHiddenClosed"" IsOpen=""False"" ClosedDisplayMode=""Hidden""/>
                        <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarHiddenOpen"" IsOpen=""True"" ClosedDisplayMode=""Hidden""/>
                    </StackPanel>
				");
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"
					<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
                            ...
                            <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" IsOpen=""True"" LightDismissOverlayMode=""On"">
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""button""/>
                            </AppBar>
                        </Grid>
				");
			...
			await RunOnUIThread(() =>
			{
				var root = (FrameworkElement)XamlReader.Load(@"
					<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
                        ...
                        <StackPanel>
                            <AppBar xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBar"">
                                <AppBarButton xmlns=""using:Microsoft.UI.Xaml.Controls"" x:Name=""appBarButton"" Icon=""Add"" Label=""Add""/>
                            </AppBar>
                        </StackPanel>
                    </Grid>
				");
